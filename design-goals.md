...
This includes bugs/exploits that have a legitimate use case (and can't be used for evil  👺) intact! Most exploits commonly used/abused by the technical minecraft community will stay, for example...  Within acceptable limits, of course. *There will always be some exceptions to this rule, but I'll try to get everyone to agree on changes before taking action should the need arise.*
<br>
<br>
